...
public class ManageUserAccountJPanel extends javax.swing.JPanel {
    ...
    private void createUserJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_createUserJButtonActionPerformed
        ...
        if(!nameJTextField.getText().isEmpty() || jPasswordField1.getPassword() != null){
         
            if(!validateEmail(nameJTextField.getText())){
               JOptionPane.showMessageDialog(null, "Username is not a valid email");
                return; 
            }
            
            if(!validatePassword(String.valueOf(jPasswordField1.getPassword()))){
                 JOptionPane.showMessageDialog(null, "Password should have atleast one Special Char, Capital Letter, Number "
                        + "and should be of min 6 letters upto 9");
                return;
            }
